...
abstract class REST_Controller extends CI_Controller
{
	...
	*/
	...
	{
		parent::__construct();
		$this->execution_tme = microtime(true);
	...
	public function response($data = array(), $http_code = null)
	{
		...
		else
		{
			...
			if (method_exists($this, '_format_'.$this->response->format))
			{
				...
				//$data['Execution_time'] = (microtime(true)-$this->execution_tme)." Sec";
...
//				$data['Execution_time'] = (microtime(true)-$this->execution_tme)." Sec";
			...
			{
				$output = $data ;
//				." 				Execution Time : ". (microtime(true)-$this->execution_tme)." Sec";
			}
		}
